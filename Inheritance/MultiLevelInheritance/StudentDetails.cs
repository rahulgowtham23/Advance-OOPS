...
namespace MultiLevelInheritance
{
    public class StudentDetails : PersonalDetails
    {
        ...
        public StudentDetails(string studentID,string userID,string name, string fatherName,Gender gender, long phoneNumber, int standard, string yearOfJoining):base(name, fatherName, gender, phoneNumber)
        {
            //auto incrementaion
